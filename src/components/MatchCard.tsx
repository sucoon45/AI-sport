...
import { Clock, ShieldCheck, Zap, RefreshCw, CheckCircle2, AlertTriangle, Target, CreditCard, Coins } from 'lucide-react'
        ...
        <div className="glass-card flex flex-col gap-8 overflow-hidden relative group hover-lift">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/5 relative z-10">
                <div className="flex flex-col">
                    ...
                    <span className="text-sm font-black text-emerald-400 italic uppercase tracking-tight">{match.prediction.type}</span>
                </div>
                <button 
